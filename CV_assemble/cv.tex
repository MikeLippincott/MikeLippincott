...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://www.mikelippincott.github.io}{\Large Michael J. Lippincott}} & Email : \href{mailto:1michaell2017@gmail.com}{1michaell2017@gmail.com}\\
  \href{http://www.mikelippincott.github.io}{http://www.mikelippincott.github.io} & Mobile : +1-(636)-300-7577 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {University of Colorado Anschutz Medical Campus, Computational Cell Biology}{Aurora, CO}
    \resumeSubheading
      {BS}{Aug. 2017 - May. 2021}
      {Maryville University of Saint Louis, Biochemistry and Data Science}{Saint Louis, MO}
...
\section{Presentations and Invited Lectures}
  \resumeSubHeadingListStart
    \resumeSubheading
      {High dimensional microscopy for high-content high-throughput drug screens}{Jan. 28, 2026}
      {Michael Johnson Seminar Series, Maryville University}{Saint Louis, MO}
    \resumeSubheading
      {3D Microscopy Framework in Patient-Derived NF1 Organoid Drug Screening}{Dec. 4, 2025}
      {Neurofibramatosis Young Investigator's Forum}{Baltimore, MD}
    \resumeSubheading
      {High-content live-cell time-lapse imaging predicts cells about to die via apoptosis}{Oct. 27, 2025}
      {Society of Biomolecular Imaging and Informatics}{Boston, MA}
    \resumeSubheading
      {3D Deep Learning Microscopy Framework in Patient-Derived NF1 Organoid Drug Screening}{Oct. 26, 2025}
      {Society of Biomolecular Imaging and Informatics}{Boston, MA}
    \resumeSubheading
      {3D Deep Learning Microscopy Framework in Patient-Derived NF1 Organoid Drug Screening}{Oct. 24, 2025}
      {Cell Biology, Stem Cells, and Development Retreat}{Estes Park, CO}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Feb. 10, 2025}
      {Systems applications for cancer biology}{Aurora, CO}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Dec. 3, 2024}
      {American Society for Cell Biology Cell Bio conference}{San Diego, CA}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Oct. 18, 2024}
      {Cell Biology, Stem Cells, and Development Retreat}{Breckinridge, CO}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Aug. 27, 2024}
      {Center for Health Artificial Intelligence Retreat}{Denver, CO}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Jul. 18, 2024}
      {Computational Systems for Integrative Genomics}{New York, NY}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Dec. 3, 2023}
      {American Society for Cell Biology Cell Bio conference}{Boston, MA}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Aug. 19, 2023}
      {Center for Health Artificial Intelligence Retreat}{Aurora, CO}
    \resumeSubheading
      {A morphology and secretome map of pyroptosis}{Oct. 13, 2023}
      {Cell Biology, Stem Cells, and Development Retreat}{Breckinridge, CO}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   ...
   \item{
     \textbf{Core Skills}{: Machine Learning, Deep Learning, Statistical Analysis, Data Visualization, Data Wrangling, Data Mining, database Management}
    }
 \resumeSubHeadingListEnd
...
\section{Publications}
  Google Scholar page (with citation metrics):
    ...
    \item {Michael J. Lippincott, Jenna Tomkinson, Ibrahim Bilem, Mahomi Suzuki, Akiko Nakde, Toshiaki Endou, Simon Mathien, Felix Lavoie-Perusse, Carla Basualto-Alarcón, Gregory P Way. (2025) High-content live-cell time-lapse imaging predicts cells about to die via apoptosis. In Review at Cell Reports Methods. bioRxiv. https://doi.org/10.1101/2025.10.23.684203 }
    \item {Dave Bunten, Jenna Tomkinson, Erik Serrano, Michael J. Lippincott, Kenneth I. Brewer, Vince Rubinetti, Faisal Alquaddoomi, Gregory P. Way. (2025) Scalable data harmonization for single-cell image-based profiling with CytoTable. In Review at Patterns. bioRxiv. https://doi.org/10.1101/2025.06.19.660613 }
    ...
    \item {Michael J. Lippincott, Jenna Tomkinson, Dave Bunten, Milad Mohammadi, Johanna Kastl, Johannes Knop, Ralf Schwandner, Jiamin Huang, Grant Ongo, Nathaniel Robichaud, Milad Dagher, Masafumi Tsuboi, Carla Basualto-Alarcón, Gregory P. Way. (2025) A morphology and secretome map of pyroptosis. MBoC. https://doi.org/10.1091/mbc.E25-03-0119 }
    \item {Srivastava H, Michael J. Lippincott, Currie J, Canfield R, Lam MPY, Lau E. (2022) Protein prediction models support widespread post-transcriptional regulation of protein abundance by interacting partners. PLOS Computational Biology. https://doi.org/10.1371/journal.pcbi.1010702 }
    \item {Lister-Shimauchi EH, McCarthy B, Michael J. Lippincott, Ahmed S. (2022) Genetic and Epigenetic Inheritance at Telomeres. Epigenomes. https://doi.org/10.3390/epigenomes6010009 }
