...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{http://www.mikelippincott.github.io}{http://www.mikelippincott.github.io} \\
\end{tabular*}
...
\section{Presentations and Invited Lectures}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Oral presentation}{6/30/2026}
      {Children's Tumor Foundation - NF Research Conference}{Denver, CO}
    \resumeSubheading
      {Oral presentation}{June 22, 2026}
      {Cold Spring Harbor Laboratory - Cell modeling in space and time}{Cold Spring Harbor, NY}
    \resumeSubheading
      {Poster presentation}{May 20, 2026}
      {Society for Laboratory Automation and Screening (SLAS) Europe}{Vienna, Austria}
    \resumeSubheading
    ...
    \resumeSubheading
      {Poster presentation}{Oct. 26, 2025}
      {Society of Biomolecular Imaging and Informatics}{Boston, MA}
    \resumeSubheading
...
\section{Publications}
  Google Scholar page (with citation metrics):
    ...
    \begin{enumerate}[label=\arabic*, start=10, before=\let\originalitem\item\renewcommand{\item}{\addtocounter{enumi}{-2}\originalitem}]
